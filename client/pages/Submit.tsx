  ...
  const handleSubmit = async (e?: FormEvent) => {
    ...
    if (!name.trim() || !email.trim() || !comment.trim() || !agree) {
      toast({
        ...
        description: "Please fill required fields and accept terms.",
        open: true,
      });
      return;
    }
    ...
    try {
      ...
      toast({
        ...
        description: "Thank you — your comment has been received.",
        open: true,
      });
      resetForm();
    ...
    <div className="min-h-screen bg-jansoch-cream py-12">
      <div className="container mx-auto px-4">
        ...
        <p className="text-center text-gray-700 max-w-2xl mx-auto mb-8">
          Your feedback is valuable in shaping India’s corporate governance
          policies. Please share your thoughts, suggestions, and concerns on the
          draft legislations.
        </p>
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <textarea
                      ...
                      rows={4}
                      className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2"
                      placeholder="Please provide your detailed comments"
                      required
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={4}
                      className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2"
                      placeholder="Use topics/sources/your reference"
                    />
                  </div>
                </div>
                ...
                <div className="mt-4">
                  <label className="block text-sm font-medium text-gray-700">
                    Memo/Representative response
                  </label>
                  <input
                    value={additional}
                    onChange={(e) => setAdditional(e.target.value)}
                    className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2"
                    placeholder="If you have any alternative suggestions or recommendations..."
                  />
                </div>
                ...
                <div className="mt-4 flex items-start gap-3">
                  ...
                  <label htmlFor="agree" className="text-sm text-gray-700">
                    ...
                    submission will be recorded and included as the public
                    transparency ledger.
                  </label>
                </div>
          ...
          <aside className="space-y-4">
            ...
            <div className="bg-white p-4 rounded shadow">
              ...
              <p className="text-sm text-gray-700">
                Your submissions will be acknowledged and may be included in the
                public transparency ledger to provide an open comment process.
                Personal data will be handled as per policy.
              </p>
            </div>
